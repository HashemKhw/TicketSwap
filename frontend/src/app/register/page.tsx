...
export default function RegisterPage() {
  ...
  return (
    <div className="relative mx-auto max-w-md overflow-hidden py-8">
      <div className="absolute -left-10 top-4 h-56 w-56 rounded-full bg-[rgba(53,37,205,0.08)] blur-3xl" />
      <div className="absolute -bottom-12 right-0 h-60 w-60 rounded-full bg-[rgba(0,63,172,0.08)] blur-3xl" />
